...
function drawHUD()
{
    ...
    if (titleScreenMode)
    {
        ...
        if (!enhancedMode || time > 5)
        {
            ...
            {
                drawHUDText('CLICK TO PLAY', vec3(.5,.92), .07, undefined, 'monospace',undefined,900,undefined,undefined,undefined,3);
                drawHUDText('PRESS M FOR MULTIPLAYER', vec3(.5,.97), .05, undefined, 'monospace',undefined,700,undefined,undefined,undefined,2);
            }
        }
    }
